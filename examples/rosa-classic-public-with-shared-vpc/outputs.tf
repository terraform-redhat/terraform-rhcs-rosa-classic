...
output "account_role_prefix" {
  value       = module.account_iam_resources[0].account_role_prefix
  description = "The prefix used for all generated AWS resources."
}

output "account_roles_arn" {
  value       = module.account_iam_resources[0].account_roles_arn
...
output "path" {
  value       = module.account_iam_resources[0].path
  description = "The arn path for the account/operator roles as well as their policies."
}

output "oidc_config_id" {
  value       = module.oidc_config_and_provider[0].oidc_config_id
