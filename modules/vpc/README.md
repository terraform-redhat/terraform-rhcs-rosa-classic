...
| <a name="input_availability_zones_count"></a> [availability\_zones\_count](#input\_availability\_zones\_count) | The count of availability zones to use within the specified AWS region, where pairs of public and private subnets are generated. Valid only when availability\_zones variable is not provided. | `number` | `null` | no |
