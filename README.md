...
| <a name="input_ignore_machine_pools_deletion_error"></a> [ignore\_machine\_pools\_deletion\_error](#input\_ignore\_machine\_pools\_deletion\_error) | Default value for ignore\_deletion\_error across all machine pools. Can be overridden per pool. | `bool` | `null` | no |
